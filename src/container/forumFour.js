...
export default function ForumFour() {
  this.state = {
    comment: '',
  };
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.photoContainer}>
        <MaterialInitials
          ...
          single={false}
        />
        <Text style={styles.name}>Tony Zhu</Text>
      ...
      <View style={styles.subCard}>
        ...
        <Comment
          ...
          Color={'white'}
          Subtitle={'Recuerda que eres administrador'} //pasale el comentario que generas con el input de arriba
        />
      </View>
    </SafeAreaView>
  );
