...
export default class ForumOne extends React.Component {
  constructor() {
    super();
  ...
  render() {
    ...
    setTimeout(() => {
      this.setState({Comentario: 'Buen trabajo Compañera'});
    }, 9000);
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.photoContainer}>
          <MaterialInitials
            ...
            backgroundColor={'#7a7dff'} //aqui tienes que pasarle el color de fondo de la pantalla de inicio
            color={'white'} //aqui tienes que pasarle el color del texto de la pantalla de inicio
            size={100}
            text={'Shantal de Leon'} //aqui tienes que pasarle el nombre de la pantalla de inicio
            single={false}
          />
        ...
        <View style={styles.newComment}>
          ...
          <View style={styles.cardInput}>
            <Input style={styles.Input} placeholder={this.state.estados} />
            <TouchableOpacity
